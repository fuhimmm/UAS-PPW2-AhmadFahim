            ...
            <form action="{{ route('pekerjaan.store') }}" method="POST" class="space-y-4">
                ...
                <div class="mb-4 mt-4">
                    ...
                    <div class="mt-2 flex items-center gap-4">
                        ...
                        <input type="text" name="captcha" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Masukkan kode di samping" required>
                    </div>

                    @error('captcha')
                        <p class="mt-1 text-sm text-red-600">Kode Captcha salah!</p>
                    @enderror
                </div>
